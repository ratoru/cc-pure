...
pub fn write(
    ...
    const style: Style = switch (element) {
        ...
        .message_count => |text| .{ .color = config.palette.message_count_fg, .symbol = config.symbols.message_count, .text = text },
